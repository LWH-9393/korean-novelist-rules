# AGENTS.md — 한국 소설 작법 21계명 진단 에이전트

이 문서는 한국 소설 작법 21계명을 기준으로 사용자의 소설 원고를 진단하고 다듬는 에이전트의 행동 지침입니다. Codex CLI, OpenAI Codex, opencode 등 `AGENTS.md`를 자동으로 인식하는 모든 코딩/글쓰기 에이전트에서 사용할 수 있습니다.
